...
oturum = CloudScraper()
istek  = oturum.get("https://www.dizibox.so/hello-tomorrow-1-sezon-1-bolum-izle/")
...
#     "dbxu"          : "1722403730363"
# })
oturum.headers.update({"Referer": "https://www.dizibox.so/hello-tomorrow-1-sezon-1-bolum-izle/"})
istek  = oturum.get(iframe)
secici = Selector(istek.text)
iframe = secici.css("div#Player iframe::attr(src)").get()

oturum.headers.update({"Referer": "https://www.dizibox.so/"})
istek     = oturum.get(iframe)
